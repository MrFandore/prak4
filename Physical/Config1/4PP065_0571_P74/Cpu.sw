...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#4">
    <Task Name="motor" Source="motor.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
    <Task Name="light" Source="light.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
    <Task Name="light_tami" Source="light_taming.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  </TaskClass>
